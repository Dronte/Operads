...
applyReconstruction :: (Ord a, Show a, TreeOrdering t, Num n, Eq n) => Embedding a -> OperadElement a n t -> OperadElement a n t
...
findSPolynomials :: (Ord a, Show a, TreeOrdering t, Fractional n, Show n, Eq n) =>
                           Int -> OperadElement a n t -> OperadElement a n t -> [OperadElement a n t]
...
findNSInitialSPolynomials :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) =>
                           Int -> [OperadElement a n t] -> [OperadElement a n t] -> [OperadElement a n t]
...
findNSSPolynomials :: (Ord a, Show a, TreeOrdering t, Fractional n, Show n, Eq n) =>
                           Int -> OperadElement a n t -> OperadElement a n t -> [OperadElement a n t]
...
reduceOE :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) => Embedding a -> OperadElement a n t -> OperadElement a n t -> OperadElement a n t
...
reduceInitial :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) => OperadElement a n t -> [OperadElement a n t] -> OperadElement a n t
reduceInitial op [] = op
...
operadicBuchberger :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) => [OperadElement a n t] -> [OperadElement a n t]
operadicBuchberger gb = nub $ streamOperadicBuchberger maxBound (reduceBasis [] gb)

-- | Non-symmetric version of 'operadicBuchberger'.
nsOperadicBuchberger :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) => [OperadElement a n t] -> [OperadElement a n t]
...
-- from 'stepOperadicBuchberger' until no new elements are generated.
streamOperadicBuchberger :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) =>
...
streamNSOperadicBuchberger :: (Ord a, Show a, TreeOrdering t, Fractional n, Eq n, Show n) =>
                            Int -> [OperadElement a n t] -> [OperadElement a n t]
...
reduceBasis :: (Fractional n, Show n, Eq n, TreeOrdering t, Show a, Ord a) =>
               [OperadElement a n t] -> [OperadElement a n t] -> [OperadElement a n t]
